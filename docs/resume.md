...
- How CloudWatch and Grafana provide complementary observability
...
Situation: Recruiters expect Kubernetes/EKS proof for cloud/platform roles.
...
Result: The project can capture scale-out/scale-in evidence with `kubectl`, Grafana, and HPA metrics.
...
Result: The project is ready for a controlled proof deployment with explicit cleanup verification.
